...
export const PLATFORMS: PlatformMeta[] = [
  { key: "website", label: "Website", icon: "globe", input: { kind: "url" }, placeholder: "https://example.com" },
  {
    ...
    label: "GitHub",
    brand: BRAND.github,
    input: { kind: "handle", base: "https://github.com/" },
  ...
  },
  {
    ...
    label: "GitLab",
    brand: BRAND.gitlab,
    input: { kind: "handle", base: "https://gitlab.com/" },
    placeholder: "username",
  },
  {
    key: "mastodon",
    label: "Mastodon",
    brand: BRAND.mastodon,
    input: { kind: "fedi" },
  ...
  },
  {
    key: "pixelfed",
    label: "Pixelfed",
    brand: BRAND.pixelfed,
    input: { kind: "fedi" },
    placeholder: "@username@pixelfed.social",
  },
  {
    key: "bluesky",
    label: "Bluesky",
    brand: BRAND.bluesky,
    input: { kind: "handle", base: "https://bsky.app/profile/" },
  ...
  { key: "x", label: "X", brand: BRAND.x, input: { kind: "handle", base: "https://x.com/" }, placeholder: "username" },
  {
    ...
    input: { kind: "handle", base: "https://instagram.com/" },
    placeholder: "username",
  },
  {
    key: "youtube",
    label: "YouTube",
    brand: BRAND.youtube,
    input: { kind: "handle", base: "https://youtube.com/@" },
    placeholder: "channel",
  },
  {
    key: "linkedin",
  ...
  },
  {
    key: "letterboxd",
    label: "Letterboxd",
    brand: BRAND.letterboxd,
    input: { kind: "handle", base: "https://letterboxd.com/" },
    placeholder: "username",
  },
  {
    key: "spotify",
    label: "Spotify",
    brand: BRAND.spotify,
    input: { kind: "handle", base: "https://open.spotify.com/user/" },
    placeholder: "user id",
  },
  {
    key: "matrix",
  ...
  { key: "xmpp", label: "XMPP", brand: BRAND.xmpp, input: { kind: "xmpp" }, placeholder: "username@server.tld" },
  {
    ...
    label: "Signal",
    brand: BRAND.signal,
    input: { kind: "handle", base: "https://signal.me/#u/" },
    placeholder: "username",
  },
  {
    key: "telegram",
    ...
    input: { kind: "handle", base: "https://t.me/" },
    placeholder: "username",
  },
